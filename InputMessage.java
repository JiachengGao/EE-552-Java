...
public class InputMessage extends JPanel implements ActionListener{
	...
	public InputMessage(File file)
	{
		...
		input=new Button("add to contact");
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==input)
		{
			...
			if(number.length()>0||name.length()>0)
			{
				...
				{
					String m="already exist, and new message will replace the previous！";
					int ok=JOptionPane.showConfirmDialog(this,m,"conform",
			...
			{
				String warning="must input NO. or Name！";
